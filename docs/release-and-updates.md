...
The workflow fails before publishing a macOS artifact when any of these values is missing. Tauri updater signatures alone do not satisfy Gatekeeper: the application bundle must also be code-signed and notarized by Apple. Without this, macOS may report that the application is damaged and cannot be opened.
