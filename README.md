...
Mock mode also opens a synthetic **What's new** preview at startup. Close it with **Got it**, then reopen it from **About → Release notes**. The preview uses sample versions and does not mark any real release notes as seen.
